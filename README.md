...
This was completed as a guided project during my data engineering studies. I used the course structure to build the pipeline end to end, then added my own documentation, notes, screenshots, and explanations so the repo can serve as both a portfolio project and a future study reference.

The goal of this repo is not just to show that the services were created. It is meant to explain how the pieces fit together: why API Gateway, Lambda, Kinesis, Firehose, S3, Snowpipe, IAM, and CloudWatch are used, what each service contributes, and how valid and invalid events move through the pipeline.

## Deeper Learning Notes

The main README gives the quick project overview for recruiters, managers, and technical reviewers. The `learning-notes/` folder goes deeper and explains the same project in a more beginner-friendly way. That folder is useful for students, junior engineers, or future-me reviewing the project later.

Helpful follow-up docs:

- [`learning-notes/end-to-end-walkthrough.md`](learning-notes/end-to-end-walkthrough.md) — plain-English explanation of the whole pipeline
- [`learning-notes/service-by-service-notes.md`](learning-notes/service-by-service-notes.md) — what each AWS/Snowflake service does and why it is used
- [`learning-notes/s3-iam-study-notes.md`](learning-notes/s3-iam-study-notes.md) — S3/IAM concepts connected back to this project
- [`learning-notes/operations-and-error-handling.md`](learning-notes/operations-and-error-handling.md) — monitoring, errors, reprocessing, and why Firehose may not write instantly
- [`learning-notes/project-explanation-guide.md`](learning-notes/project-explanation-guide.md) — polished but natural project explanation for review/interview conversations
...
│   ├── operations-and-error-handling.md
│   ├── project-explanation-guide.md
│   ├── s3-iam-study-notes.md
